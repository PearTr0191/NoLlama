...
| Diagram | Answers |
| --- | --- |
| [request-flow.mmd](request-flow.mmd) | Which handler, slot, and generation path serves a given request? Why did my `tools` get ignored? Why is a tool turn buffered instead of token-streamed? |
